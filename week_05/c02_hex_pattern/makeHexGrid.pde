//   A mess of code that was/is a first pass at making a hex grid
...
ArrayList<HexPoint> makeGrid(float radius) {
  ...
  int number_of_hexes = ceil(leftover_width/(radius*2));
  float start_x_offset = -(number_of_hexes*(radius*2));
